# Generated by Django 4.2.11 on 2025-07-13 15:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0014_delete_contact_delete_eventsgallery_delete_mentee_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eventImage1', models.FileField(upload_to='mediafiles/')),
                ('eventImage2', models.FileField(upload_to='mediafiles/')),
                ('eventImage3', models.FileField(upload_to='mediafiles/')),
                ('eventImage4', models.FileField(upload_to='mediafiles/')),
                ('eventImage5', models.FileField(upload_to='mediafiles/')),
                ('eventImage6', models.FileField(upload_to='mediafiles/')),
                ('eventImage7', models.FileField(upload_to='mediafiles/')),
                ('eventImage8', models.FileField(upload_to='mediafiles/')),
                ('eventImage9', models.FileField(upload_to='mediafiles/')),
                ('eventImage10', models.FileField(upload_to='mediafiles/')),
            ],
        ),
        migrations.CreateModel(
            name='Mentee',
